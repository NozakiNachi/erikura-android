...
object ErikuraConfig {
    ...
    fun jobNewReportURLString(job_id: Int?): String {
        return BuildConfig.SERVER_BASE_URL + "reports/new?job_id=" + job_id
    }

    fun jobEditReportURLString(job_id: Int?, report_id: Int?): String {
        return BuildConfig.SERVER_BASE_URL + "reports/" + report_id + "/edit?job_id=" + job_id
    }
