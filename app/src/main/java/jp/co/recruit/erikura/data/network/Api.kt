...
//    }
    ...
    fun placeCautions(placeId: Int, jobKindId: Int, onError: ((message: List<String>?) -> Unit)? = null, onComplete: (result: List<Caution>) -> Unit){
        executeObservable(
            erikuraApiService.placeCautions(placeId, jobKindId),
            onError = onError
        ) { body ->
